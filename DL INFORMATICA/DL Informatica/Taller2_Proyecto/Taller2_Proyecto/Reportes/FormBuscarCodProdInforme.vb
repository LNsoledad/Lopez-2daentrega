Public Class FormBuscarCodProdInforme
    Dim objProducto As Eproductos = New Eproductos

    Private Sub FormBuscarCodProdInforme_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cargarGrid()
...
#Region "Carga datagrid en informe comportamiento anual de producto"

    Private Sub dtgPRODUCTOSActivos_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dtgPRODUCTOSActivos.CellDoubleClick
        ...
        FormCompAnualProducto.tbxCOD.Text = codigo
