Public Class FormMejoresClientesPorCantComprada
    Private Sub FormMejoresClientesPorCantComprada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBUSCAR_Click(sender As Object, e As EventArgs) Handles btnBUSCAR.Click
        If dtpDESDE.Value > dtpHASTA.Value Then
            ...
            Me.ReportViewer1.RefreshReport()
        Else
            If Me.ClientesTableAdapter.MostrarMejoresClientesPorCantidad(Me.DataSetProyecto.Clientes, dtpDESDE.Text, dtpHASTA.Text) = False Then
